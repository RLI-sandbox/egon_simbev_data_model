...
package_dir = os.path.abspath(os.path.join(project_dir, "egon_simbev_data_model"))

sys.path.insert(0, project_dir)

import egon_simbev_data_model  # noqa: E402

# -- Project information -----------------------------------------------------

# General information about the project.
project = "egon-simbev-data-model"
author = egon_simbev_data_model.__author__
copyright = "2021, " + egon_simbev_data_model.__author__
...
version = egon_simbev_data_model.__version__
# The full version, including alpha/beta/rc tags.
release = egon_simbev_data_model.__version__
...
html_theme_options = {
    ...
    "fixed_sidebar": "true",
    "github_user": "khelfen",
    "github_repo": "egon-simbev-data-model",
    "github_banner": "true",
    "github_button": "true",
    "github_type": "star",
